...
- [x] 6. 認証・認可基盤の実装（Phase 1）
- [x] 6.1 NextAuth v5 によるログイン・セッション管理
...
- [x] 16. AI コーチング（対話型品質ゲート）の実装
- [x] 16.1 品質ゲート AI プロンプトと判定ロジック
...
- [x] 21. ダッシュボード & レポートの実装
- [x] 21.1 ロール別 KPI ダッシュボード
